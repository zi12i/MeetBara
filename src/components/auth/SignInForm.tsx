...
export default function SignInForm() {
  ...
  return (
    // 👉 부모 컨테이너에서 좌우 여백(px-8 ~ 12)과 최대 너비(max-w-md)를 잡아 중앙 정렬감을 줍니다.
    <div className="w-full max-w-md mx-auto px-4 sm:px-8">
      <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
        ...
        <div className="pt-2">
          <Button 
            className="w-full h-14 !bg-[#86B156] hover:!bg-[#769d4b] text-white font-black text-lg rounded-2xl border-none transition-all active:scale-[0.98] shadow-lg shadow-[#86B156]/20" 
          >
            로그인
          </Button>
        </div>
