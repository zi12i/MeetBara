...
const LiveMeeting: React.FC = () => {
  ...
  const [meetingTitle, setMeetingTitle] = useState("하반기 채용 연계형 인턴십 기획 회의");
  ...
  const [meetingMembers, setMeetingMembers] = useState<string[]>(["김효겸", "정승경", "오지민", "이예빈", "성준호"]);
  ...
  const [agendas, setAgendas] = useState<Agenda[]>([
    { id: 1, text: "[미결정] 선발 기준 및 유형 논의", isCompleted: true },
    { id: 2, text: "[신규] 선발 기간 및 서류 전형 심사 논의", isCompleted: false },
    { id: 3, text: "[신규] 근무 조건 및 계약 기간 산정", isCompleted: false },
  ]);
